...
const CourseCard = ({ title, description, date, courseId, thumbnailUrl }) => {
  ...
  return (
    <div className="card font-poppins w-80 h-auto rounded-2xl bg-[#212121] shadow-[15px_15px_30px_rgb(25,25,25),-15px_-15px_30px_rgb(60,60,60)] text-gray-700">
      ...
      <div className="p-6">
        ...
        <p className="text-base my-2 font-light leading-relaxed">{description}</p>
