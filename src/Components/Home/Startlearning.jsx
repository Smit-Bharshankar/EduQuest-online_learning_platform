...
function Startlearning() {
  return (
    <div className="max-h-screen pb-8 min-h-[50%] font-poppins w-full pt-8 flex md:flex-row items-center justify-center gap-4">
      
      {/*text section*/}
      <div className="w-1/2 ml-4 flex items-center justify-center">
        <h1 className=" text-clip text-pretty text-center font-medium text-xl w-[90%]">
     ...
     {/*img section */}
      <div className="relative w-1/2 mr-4 border-slate-400 border rounded-lg overflow-hidden">
        <img
